package hibernate.inheritance.tablepersubclass.discriminator;
...
public class BillingDetailsTest {
	...
	public void testCase1() {
		SessionFactory sessionFactory = 
			new Configuration().configure("hibernate/inheritance/tablepersubclass/discriminator/hibernate.cfg.xml").buildSessionFactory();
